...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link href="<?php echo base_url("lib/iCheck/square/blue.css"); ?>" rel="stylesheet" type="text/css" />
...
<!--        <div class="social-auth-links text-center">
    ...
    <!-- iCheck -->
    <script src="<?php echo base_url("lib/iCheck/icheck.min.js"); ?>" type="text/javascript"></script>
    <script>
      $(function () {
        $('input').iCheck({
