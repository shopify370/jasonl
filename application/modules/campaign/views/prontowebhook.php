                    ...
                    <?php  $count=1;
                        foreach ($webook_data as $dataz) { ?>
                            <tr>
                                ...
                                <td><input type="text" name="prontoacweb[]" value="<?php echo $dataz->webhook_url; ?>" size="105" /></td>
...
<script type="text/javascript">
    jQuery('.row a.slot').on('click',function(){
        var newslot='<tr><td></td><td><input type="text" name="prontoacweb[]" value="" size="105"/></td><td><a href="javascript:void(0);" class="remove">Remove</a></td></tr>';
