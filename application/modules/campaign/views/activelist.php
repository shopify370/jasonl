...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <?php 
            ...
            if (strpos($url,'activeError') !== false) {
                $select_err='selected';
                $select_dta='';
            } else {
                $select_err='';
        ...
        ?>
        <h1>Jsonal</h1>
		<h2><?php echo 'Active Campaign to Pronto'; ?></h2>
            <ol class="breadcrumb">
                ...
                <tr>
                    <td>
                        <select name="type" id="selecttype" style="width: 121px; height: 34px;" onchange="location = this.value;">
                            <option value="<?php echo base_url() . 'campaign/activepage/activeData'; ?>" <?php echo $select_dta; ?>>All</option>
                            <option value="<?php echo base_url() . 'campaign/activepage/activeError'; ?>" <?php echo $select_err; ?>>Error</option>
                        </select>
                    </td>
            </table>
        </form>
                    ...
                    <?php
                        foreach ($errordata as $dataz) { 
                            ...
                            <tr class="<?php echo $error; ?>">
                                ...
                                <td><?php if(isset($dataz['id'])){ echo 'Error'; } else{ echo 'Success'; } ?></td>
                                <td><?php if(isset($dataz['error_msg'])){ ?><?php echo $dataz['error_msg']; ?> <?php } ?></td>
                            </tr>
                        <?php } ?>
                </table>
