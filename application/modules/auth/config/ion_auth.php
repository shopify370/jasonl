 ...
 */
$config['site_title']                 = "Creative Market";       // Site Title, example.com
$config['admin_email']                = "admin@creativemarket.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['staff_admin_1_group']          = 'staff_admin_1';  
$config['staff_admin_2_group']          = 'staff_admin_2';  
$config['identity']                   = 'email';             // A database column which is used to login with
$config['first_name']                   = 'first_name';             // A database column which is used to login with
 ...
 */
$config['email_forgot_password'] = 'forgot_password_template.php';
